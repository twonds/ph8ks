...
def create_authorization_v1_namespaced_local_subject_access_review(namespace, body, dryRun=None, fieldManager=None, pretty=None):  # noqa: E501
    ...
    if connexion.request.is_json:
        body = IoK8sApiAuthorizationV1LocalSubjectAccessReview.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def create_authorization_v1_self_subject_access_review(body, dryRun=None, fieldManager=None, pretty=None):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = IoK8sApiAuthorizationV1SelfSubjectAccessReview.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def create_authorization_v1_self_subject_rules_review(body, dryRun=None, fieldManager=None, pretty=None):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = IoK8sApiAuthorizationV1SelfSubjectRulesReview.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def create_authorization_v1_subject_access_review(body, dryRun=None, fieldManager=None, pretty=None):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        body = IoK8sApiAuthorizationV1SubjectAccessReview.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def get_authorization_v1_api_resources():  # noqa: E501
