...
from swagger_server.models.io_k8s_api_autoscaling_v2beta2_horizontal_pod_autoscaler import IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler  # noqa: E501
from swagger_server.models.io_k8s_api_autoscaling_v2beta2_horizontal_pod_autoscaler_list import IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerList  # noqa: E501
...
def create_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
    ...
    :rtype: IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler
    """
    if connexion.request.is_json:
        body = IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler.from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'


def delete_autoscaling_v2beta2_collection_namespaced_horizontal_pod_autoscaler(namespace, pretty=None, allowWatchBookmarks=None, body=None, _continue=None, dryRun=None, fieldSelector=None, gracePeriodSeconds=None, labelSelector=None, limit=None, orphanDependents=None, propagationPolicy=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def delete_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(name, namespace, pretty=None, body=None, dryRun=None, gracePeriodSeconds=None, orphanDependents=None, propagationPolicy=None):  # noqa: E501
...
def get_autoscaling_v2beta2_api_resources():  # noqa: E501
...
def list_autoscaling_v2beta2_horizontal_pod_autoscaler_for_all_namespaces(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    ...
    :rtype: IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerList
    """
    return 'do some magic!'


def list_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(namespace, pretty=None, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def patch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty=None, dryRun=None, fieldManager=None, force=None):  # noqa: E501
...
def patch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty=None, dryRun=None, fieldManager=None, force=None):  # noqa: E501
...
def read_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(name, namespace, pretty=None, exact=None, export=None):  # noqa: E501
...
def read_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status(name, namespace, pretty=None):  # noqa: E501
...
def replace_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(name, namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
...
def replace_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status(name, namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
...
def watch_autoscaling_v2beta2_horizontal_pod_autoscaler_list_for_all_namespaces(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def watch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(name, namespace, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def watch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_list(namespace, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
