...
def create_node_v1alpha1_runtime_class(body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
    """create_node_v1alpha1_runtime_class
...
def delete_node_v1alpha1_runtime_class(name, pretty=None, body=None, dryRun=None, gracePeriodSeconds=None, orphanDependents=None, propagationPolicy=None):  # noqa: E501
    """delete_node_v1alpha1_runtime_class
...
def get_node_v1alpha1_api_resources():  # noqa: E501
    """get_node_v1alpha1_api_resources
...
def list_node_v1alpha1_runtime_class(pretty=None, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    """list_node_v1alpha1_runtime_class
    ...
    :rtype: IoK8sApiNodeV1alpha1RuntimeClassList
    """
    return 'do some magic!'


def patch_node_v1alpha1_runtime_class(name, body, pretty=None, dryRun=None, fieldManager=None, force=None):  # noqa: E501
    """patch_node_v1alpha1_runtime_class
...
def read_node_v1alpha1_runtime_class(name, pretty=None, exact=None, export=None):  # noqa: E501
    """read_node_v1alpha1_runtime_class
...
def replace_node_v1alpha1_runtime_class(name, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
    """replace_node_v1alpha1_runtime_class
...
def watch_node_v1alpha1_runtime_class(name, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    """watch_node_v1alpha1_runtime_class

    watch changes to an object of kind RuntimeClass. deprecated: use the &#39;watch&#39; parameter with a list operation instead, filtered to a single item with the &#39;fieldSelector&#39; parameter. # noqa: E501
...
def watch_node_v1alpha1_runtime_class_list(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    """watch_node_v1alpha1_runtime_class_list

    watch individual changes to a list of RuntimeClass. deprecated: use the &#39;watch&#39; parameter with a list operation instead. # noqa: E501
