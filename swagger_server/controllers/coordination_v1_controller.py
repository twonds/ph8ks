...
from swagger_server.models.io_k8s_api_coordination_v1_lease import IoK8sApiCoordinationV1Lease  # noqa: E501
from swagger_server.models.io_k8s_api_coordination_v1_lease_list import IoK8sApiCoordinationV1LeaseList  # noqa: E501
...
def create_coordination_v1_namespaced_lease(namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
...
def delete_coordination_v1_namespaced_lease(name, namespace, pretty=None, body=None, dryRun=None, gracePeriodSeconds=None, orphanDependents=None, propagationPolicy=None):  # noqa: E501
...
def get_coordination_v1_api_resources():  # noqa: E501
...
def list_coordination_v1_lease_for_all_namespaces(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    ...
    :rtype: IoK8sApiCoordinationV1LeaseList
    """
    return 'do some magic!'


def list_coordination_v1_namespaced_lease(namespace, pretty=None, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def patch_coordination_v1_namespaced_lease(name, namespace, body, pretty=None, dryRun=None, fieldManager=None, force=None):  # noqa: E501
...
def read_coordination_v1_namespaced_lease(name, namespace, pretty=None, exact=None, export=None):  # noqa: E501
...
def replace_coordination_v1_namespaced_lease(name, namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
...
def watch_coordination_v1_lease_list_for_all_namespaces(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    """watch_coordination_v1_lease_list_for_all_namespaces

    watch individual changes to a list of Lease. deprecated: use the &#39;watch&#39; parameter with a list operation instead. # noqa: E501
...
def watch_coordination_v1_namespaced_lease(name, namespace, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
    """watch_coordination_v1_namespaced_lease

    watch changes to an object of kind Lease. deprecated: use the &#39;watch&#39; parameter with a list operation instead, filtered to a single item with the &#39;fieldSelector&#39; parameter. # noqa: E501
...
def watch_coordination_v1_namespaced_lease_list(namespace, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
