...
def create_events_v1beta1_namespaced_event(namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
    ...
    if connexion.request.is_json:
        body = IoK8sApiEventsV1beta1Event.from_dict(connexion.request.get_json())  # noqa: E501
...
def delete_events_v1beta1_namespaced_event(name, namespace, pretty=None, body=None, dryRun=None, gracePeriodSeconds=None, orphanDependents=None, propagationPolicy=None):  # noqa: E501
...
def get_events_v1beta1_api_resources():  # noqa: E501
...
def list_events_v1beta1_event_for_all_namespaces(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def list_events_v1beta1_namespaced_event(namespace, pretty=None, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def patch_events_v1beta1_namespaced_event(name, namespace, body, pretty=None, dryRun=None, fieldManager=None, force=None):  # noqa: E501
...
def read_events_v1beta1_namespaced_event(name, namespace, pretty=None, exact=None, export=None):  # noqa: E501
...
def replace_events_v1beta1_namespaced_event(name, namespace, body, pretty=None, dryRun=None, fieldManager=None):  # noqa: E501
...
def watch_events_v1beta1_event_list_for_all_namespaces(allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def watch_events_v1beta1_namespaced_event(name, namespace, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
...
def watch_events_v1beta1_namespaced_event_list(namespace, allowWatchBookmarks=None, _continue=None, fieldSelector=None, labelSelector=None, limit=None, pretty=None, resourceVersion=None, timeoutSeconds=None, watch=None):  # noqa: E501
