...
class IoK8sApiRbacV1beta1AggregationRule(Model):
    ...
    def __init__(self, cluster_role_selectors: List[IoK8sApimachineryPkgApisMetaV1LabelSelector]=None):  # noqa: E501
        """IoK8sApiRbacV1beta1AggregationRule - a model defined in Swagger

        :param cluster_role_selectors: The cluster_role_selectors of this IoK8sApiRbacV1beta1AggregationRule.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'IoK8sApiRbacV1beta1AggregationRule':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The io.k8s.api.rbac.v1beta1.AggregationRule of this IoK8sApiRbacV1beta1AggregationRule.  # noqa: E501
    ...
    def cluster_role_selectors(self) -> List[IoK8sApimachineryPkgApisMetaV1LabelSelector]:
        """Gets the cluster_role_selectors of this IoK8sApiRbacV1beta1AggregationRule.
        ...
        :return: The cluster_role_selectors of this IoK8sApiRbacV1beta1AggregationRule.
    ...
    def cluster_role_selectors(self, cluster_role_selectors: List[IoK8sApimachineryPkgApisMetaV1LabelSelector]):
        """Sets the cluster_role_selectors of this IoK8sApiRbacV1beta1AggregationRule.

        ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added  # noqa: E501

        :param cluster_role_selectors: The cluster_role_selectors of this IoK8sApiRbacV1beta1AggregationRule.
        :type cluster_role_selectors: List[IoK8sApimachineryPkgApisMetaV1LabelSelector]
        """
