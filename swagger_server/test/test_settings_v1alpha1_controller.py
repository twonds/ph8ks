...
class TestSettingsV1alpha1Controller(BaseTestCase):
    """SettingsV1alpha1Controller integration test stubs"""
    ...
    def test_create_settings_v1alpha1_namespaced_pod_preset(self):
        ...
        response = self.client.open(
            '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets'.format(namespace='namespace_example'),
            method='POST',
    ...
    def test_delete_settings_v1alpha1_namespaced_pod_preset(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('propagationPolicy', 'propagationPolicy_example')]
        response = self.client.open(
            '/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}'.format(name='name_example', namespace='namespace_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_watch_settings_v1alpha1_namespaced_pod_preset(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/settings.k8s.io/v1alpha1/watch/namespaces/{namespace}/podpresets/{name}'.format(name='name_example', namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_settings_v1alpha1_namespaced_pod_preset_list(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/settings.k8s.io/v1alpha1/watch/namespaces/{namespace}/podpresets'.format(namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
