...
class TestAutoscalingV2beta2Controller(BaseTestCase):
    """AutoscalingV2beta2Controller integration test stubs"""
    ...
    def test_create_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(self):
        ...
        response = self.client.open(
            '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers'.format(namespace='namespace_example'),
            method='POST',
    ...
    def test_delete_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('propagationPolicy', 'propagationPolicy_example')]
        response = self.client.open(
            '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}'.format(name='name_example', namespace='namespace_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_patch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('force', true)]
        response = self.client.open(
            '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status'.format(name='name_example', namespace='namespace_example'),
            method='PATCH',
            data=json.dumps(body),
            content_type='application/json-patch+json',
            query_string=query_string)
    ...
    def test_watch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}'.format(name='name_example', namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_list(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/autoscaling/v2beta2/watch/namespaces/{namespace}/horizontalpodautoscalers'.format(namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
