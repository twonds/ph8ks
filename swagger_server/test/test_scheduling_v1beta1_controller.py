...
class TestSchedulingV1beta1Controller(BaseTestCase):
    """SchedulingV1beta1Controller integration test stubs"""
    ...
    def test_delete_scheduling_v1beta1_priority_class(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('propagationPolicy', 'propagationPolicy_example')]
        response = self.client.open(
            '/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}'.format(name='name_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_watch_scheduling_v1beta1_priority_class(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/scheduling.k8s.io/v1beta1/watch/priorityclasses/{name}'.format(name='name_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
