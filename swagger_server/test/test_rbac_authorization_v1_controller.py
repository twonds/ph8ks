...
class TestRbacAuthorizationV1Controller(BaseTestCase):
    """RbacAuthorizationV1Controller integration test stubs"""
    ...
    def test_create_rbac_authorization_v1_namespaced_role(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('fieldManager', 'fieldManager_example')]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles'.format(namespace='namespace_example'),
            method='POST',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_create_rbac_authorization_v1_namespaced_role_binding(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('fieldManager', 'fieldManager_example')]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings'.format(namespace='namespace_example'),
            method='POST',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_delete_rbac_authorization_v1_cluster_role(self):
        ...
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}'.format(name='name_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_delete_rbac_authorization_v1_cluster_role_binding(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('propagationPolicy', 'propagationPolicy_example')]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}'.format(name='name_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_delete_rbac_authorization_v1_namespaced_role(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('propagationPolicy', 'propagationPolicy_example')]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}'.format(name='name_example', namespace='namespace_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_delete_rbac_authorization_v1_namespaced_role_binding(self):
        ...
        query_string = [('pretty', 'pretty_example'),
                        ...
                        ('propagationPolicy', 'propagationPolicy_example')]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings/{name}'.format(name='name_example', namespace='namespace_example'),
            method='DELETE',
            data=json.dumps(body),
            content_type='*/*',
            query_string=query_string)
    ...
    def test_watch_rbac_authorization_v1_cluster_role(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/watch/clusterroles/{name}'.format(name='name_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_rbac_authorization_v1_cluster_role_binding(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/{name}'.format(name='name_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_rbac_authorization_v1_namespaced_role(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles/{name}'.format(name='name_example', namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_rbac_authorization_v1_namespaced_role_binding(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/rolebindings/{name}'.format(name='name_example', namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_rbac_authorization_v1_namespaced_role_binding_list(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/rolebindings'.format(namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
    ...
    def test_watch_rbac_authorization_v1_namespaced_role_list(self):
        ...
        query_string = [('allowWatchBookmarks', true),
                        ...
                        ('watch', true)]
        response = self.client.open(
            '/apis/rbac.authorization.k8s.io/v1/watch/namespaces/{namespace}/roles'.format(namespace='namespace_example'),
            method='GET',
            content_type='*/*',
            query_string=query_string)
        self.assert200(response,
